...
# 步骤 1: 初始化模型
neural_rendering_model = NeuralRenderingModel(input_dim=3, hidden_dim=128, encoding_dim=1024)
neural_rendering_model.to(device)  # 将模型移动到设备
print("Model architecture:")
print(neural_rendering_model)
...
bounding_box = np.array([[-5,-5,-5],[5,5,5]])  # 自定义全局范围
voxel_size = 0.1
